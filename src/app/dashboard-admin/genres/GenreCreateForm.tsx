...
export function GenreCreateForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok || !json.success) {
        setError(json.message ?? "Gagal menambahkan genre");
        return;
      }
      ...
      console.error("[GenreCreateForm] submit error", err);
  ...
  return (
    ...
    >
      <h2 className="text-lg font-semibold text-foreground">Tambah Genre Baru</h2>
