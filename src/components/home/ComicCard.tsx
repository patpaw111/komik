...
export default function ComicCard({ item }: Props) {
  ...
  return (
    <Link href={href} className="h-full">
      <article className="group flex h-full flex-col overflow-hidden rounded-xl border border-border/70 bg-card shadow-sm transition hover:-translate-y-1 hover:shadow-lg cursor-pointer">
